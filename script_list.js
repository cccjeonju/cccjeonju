...
$(function($){
	...
	var changeSubject = function() { // 과목 바꾸면 리스트 갱신
		...
		$.ajax({
			...
			// =============================================
			type: 'GET',
			url: 'https://docs.google.com/spreadsheets/d/'+KEY_SPREADSHEET+'/gviz/tq?gid='+GID_SHEET_ATTEND+'&tq=select+*+where+D+matches+\''+subject_code+'\'+and+E+<=+dateTime+\''+today+' 23:59:59\'+and+E+>=+dateTime+\''+today+' 00:00:00\'+order+by+B',
